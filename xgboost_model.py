...
model = xgb.XGBRegressor(n_estimators=100, random_state=42)  # Use XGBRegressor instead of RandomForestRegressor
...
#joblib.dump(model, 'xgboost_model.pkl')  # Save the model as a .pkl file
